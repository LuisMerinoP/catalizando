...
import { Search, Plus, Trash2, ExternalLink, LogOut, Lock, Download, ArrowUp, ArrowDown } from 'lucide-react';
...
export default function Admin() {
  ...
  const downloadCsv = () => {
    const header = 'Taller,Ubicación,Contacto,Num,Comentarios,ToDo';
    ...
    <section className="min-h-screen bg-gray-50">
      ...
      <div className="bg-primary text-white px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <h1 className="text-xl font-bold">Visitas Talleres — Admin</h1>
          <div className="flex items-center gap-4">
            <button
              onClick={downloadCsv}
              className="flex items-center gap-2 text-sm hover:text-secondary transition-colors cursor-pointer"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative mb-6">
          ...
          <input
            type="text"
            placeholder="Search by taller, contacto, comments..."
            value={search}
          ...
          <div className="flex gap-2 mt-4">
            {editingId ? (
              <>
                <button
                  onClick={saveEdit}
                  className="flex items-center gap-1 bg-secondary text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-secondary/90 transition-colors cursor-pointer"
                >
                  Save Changes
                </button>
                <button
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm mx-4 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-5 py-2 rounded-lg text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
